 ...
 * @brief Helpers class for string handling.
 */
class StringHelper implements ArrayAccess, Iterator, Countable, JsonSerializable
{
   ...
   *
   * @param string|StringHelper $string
   */
  public function __construct(StringHelper|string $string)
  {
    $this->string = (string) $string;
  }

  /**
   * Returns a TeamSpeak3_Helper_String object for the given string.
   *
   * @param  StringHelper|string $string
   * @return StringHelper
   */
  #[Pure] public static function factory(StringHelper|string $string): StringHelper {
   ...
   *
   * @param  StringHelper|string|array  $search
   * @param  StringHelper|string  $replace
   * @param  bool $caseSensitivity
   * @return StringHelper
   */
  public function replace(
	  StringHelper|string|array $search,
	  StringHelper|string $replace,
   ...
   *
   * @param  array  $args
   * @param  StringHelper|string $char
   * @return StringHelper
   */
  public function arg(array $args, StringHelper|string $char = "%"): StringHelper
  {
   ...
   *
   * @param  StringHelper|string $needle
   * @return integer
   */
  public function findLast(StringHelper|string $needle): int
  {
   ...
   * @return StringHelper
   */
  #[Pure] public function toLower(): StringHelper
  {
   ...
   * @return StringHelper
   */
  #[Pure] public function toUpper(): StringHelper {
   ...
   *
   * @param string|StringHelper $separator
   * @param int $limit
   * @return array
   */
  #[Pure] public function split(StringHelper|string $separator, int $limit = 0): array
  {
   ...
   *
   * @param  StringHelper|string $part
   * @return StringHelper
   */
  public function append(StringHelper|string$part): StringHelper
  {
    $this->string .= $part;
    return $this;
  }
   ...
   * @return StringHelper
   */
  public function prepend(StringHelper|string $part): StringHelper
  {
   ...
   *
   * @param StringHelper|string $separator
   * @param integer $first
   * @param integer $last
   * @return StringHelper
   */
  public function section(StringHelper|string $separator, int $first = 0, int $last = 0): ?StringHelper
  {
   ...
   * @return StringHelper
   */
  public function escape(): StringHelper
  {
   ...
   * @return StringHelper
   */
  public function unescape(): StringHelper
  {
  ...
  public static function fromHex($hex)
  {
    ...
    if(strlen($hex) % 2 === 1)
    {
      throw new HelpersException("given parameter '" . $hex . "' is not a valid hexadecimal number");
    }
  ...
  public function __call($function, $args)
  {
    ...
    {
      throw new HelpersException("cannot call undefined function '" . $function . "' on this object");
    }
    ...
    if(count($args))
    {
      ...
      {
        throw new HelpersException("cannot call undefined function '" . $function . "' without the " . __CLASS__ . " object parameter");
      }
   ...
   * @ignore
   */
  public function current(): CharHelper {
    return new CharHelper($this->string[$this->position]);
  }
   ...
   * @ignore
   */
  public function offsetGet($offset): ?CharHelper {
    return ($this->offsetExists($offset)) ? new CharHelper($this->string[$offset]) : null;
  }
