...
use TeamSpeak3\Helpers\ProfilerHelper;
 ...
 */
class FileTransferAdapter extends AdapterAbstract
{
  /**
  ...
  public function syn()
  {
    ...
    ProfilerHelper::init(spl_object_hash($this));

    SignalHelper::getInstance()->emit("filetransferConnected", $this);
  }
